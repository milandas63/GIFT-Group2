Day-02 (06-07-2023)
-------------------
1)  Solved the following two questions by drawing flowcharts
    a)  Draw a flowchart to find if a number is a prime number?
    b)  Draw a flowchart to print all prime numbers between 1000 through 3000?

2)  Understand and Installing Eclipse IDE
3)  Learn to run Java from Eclipse & Command line
4)  Solve deep nesting of for loop to generate multiplication tables
